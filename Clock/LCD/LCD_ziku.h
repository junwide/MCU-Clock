#ifndef __LCD_ZIKU_H__
#define __LCD_ZIKU_H__

/*********************************************
* 用PCtoLCD2002取汉字字模的设置：
* 阴码，列行式，逆向，十六进制
*********************************************/
...
{0x00,0x00,0x07,0x05,0x07,0x00},// °(91)摄氏度中的小圆圈
/*
{0x20,0x1C,0x42,0x02,0x1C,0x20}//???ó±ê??
...
* 以6*12点阵的形式显示字符
*********************************************/
unsigned char Char_6_12[][6]={
{0xF8,0x04,0x04,0x04,0xF8,0x00},
{0x01,0x02,0x02,0x02,0x01,0x00},/*"0",0*/

{0x00,0x08,0xFC,0x00,0x00,0x00},
{0x00,0x02,0x03,0x02,0x00,0x00},/*"1",1*/

{0x18,0x84,0x44,0x24,0x18,0x00},
{0x03,0x02,0x02,0x02,0x02,0x00},/*"2",2*/

{0x08,0x04,0x24,0x24,0xD8,0x00},
{0x01,0x02,0x02,0x02,0x01,0x00},/*"3",3*/

{0xC0,0xA0,0x98,0xFC,0x80,0x00},
{0x00,0x00,0x02,0x03,0x02,0x00},/*"4",4*/

{0x7C,0x24,0x24,0x24,0xC4,0x00},
{0x01,0x02,0x02,0x02,0x01,0x00},/*"5",5*/

{0xF0,0x48,0x24,0x24,0xC8,0x00},
{0x01,0x02,0x02,0x02,0x01,0x00},/*"6",6*/

{0x00,0x04,0xC4,0x34,0x0C,0x00},
{0x00,0x00,0x03,0x00,0x00,0x00},/*"7",7*/

{0xD8,0x24,0x24,0x24,0xD8,0x00},
{0x01,0x02,0x02,0x02,0x01,0x00},/*"8",8*/

{0x38,0x44,0x44,0x24,0xF8,0x00},
{0x01,0x02,0x02,0x01,0x00,0x00},/*"9",9*/
};

/*********************************************
* 以8*16点阵的形式显示字符
*********************************************/
unsigned char Char_8_16[][8]={
...
* 以 12*12点阵的形式显示汉字
*********************************************/
unsigned char Chinese_12_12[][12]={
{0x00,0xFF,0x05,0x25,0x2D,0xF5,0x25,0x25,0xF5,0x2D,0x27,0x00},
{0x08,0x07,0x01,0x09,0x05,0x03,0x01,0x01,0x0F,0x01,0x01,0x00},/*"屏",0*/

{0x82,0xBA,0xAA,0xEF,0xAA,0xBA,0xAA,0xAF,0xAA,0xBA,0x82,0x00},
{0x04,0x02,0x0F,0x02,0x02,0x0F,0x02,0x0A,0x0F,0x02,0x04,0x00},/*"幕",1*/

{0x00,0x7F,0x49,0x49,0x49,0xFF,0x49,0x49,0x49,0x7F,0x00,0x00},
{0x08,0x09,0x09,0x09,0x09,0x0F,0x09,0x09,0x09,0x09,0x08,0x00},/*"里",2*/

{0x02,0xF2,0x12,0x12,0xFA,0x56,0x52,0xF2,0x12,0x12,0xF2,0x00},
{0x00,0x0F,0x04,0x04,0x07,0x05,0x05,0x07,0x04,0x04,0x0F,0x00},/*"面",3*/
};

/*********************************************
* 以 16*16点阵的形式显示汉字
*********************************************/
unsigned char Chinese_16_16[][16]={
...
{0x00,0x00,0xFF,0x40,0x40,0x7F,0x49,0x49,0x49,0x7F,0x40,0x40,0xFF,0x00,0x00,0x00},/*"面",3*/
};
